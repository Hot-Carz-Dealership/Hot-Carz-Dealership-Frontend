...
const services = () => {
  return (
    <div className="homepage p-3" style={styles.homepage}>
      <div className="px-5 mx-5" style={styles.carDisplay}>
        <header className="flex justify-center items-center hero-text">
          Our Services
        </header>
        {/* <div
