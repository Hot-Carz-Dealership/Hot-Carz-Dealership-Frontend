    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.message || 'Failed to create employee account');
            }
            ...
            <div style={styles.mainContent}>
                ...
                <form onSubmit={handleSubmit} style={styles.form}>
                    ...
                    <div style={styles.formGroup}>
                        ...
                        <input type="text" id="city" name="city" value={formData.city} onChange={handleChange} style={styles.input} />
                    </div>
                    <div style={styles.formGroup}>
                        <label htmlFor="state" style={styles.label}>State:</label>
                        <input type="text" id="state" name="state" value="NJ" style={styles.input} disabled />
                    </div>
                    <div style={styles.formGroup}>
                        <label htmlFor="zipcode" style={styles.label}>Zipcode:</label>
                        <input type="text" id="zipcode" name="zipcode" value={formData.zipcode} onChange={handleChange} style={styles.input} />
                    </div>
                    <div style={styles.formGroup}>
                    ...
                    <div style={styles.formGroup}>
                        ...
                        <input type="password" id="confirmPassword" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} style={styles.input} />
                    </div>
                    <div style={styles.formGroup}>
                        <label htmlFor="driverID" style={styles.label}>Driver ID:</label>
                        <input type="text" id="driverID" name="driverID" value={formData.driverID} onChange={handleChange} style={styles.input} />
                    </div>
                    <div style={styles.formGroup}>
                        <label htmlFor="SSN" style={styles.label}>SSN:</label>
                        <input type="text" id="SSN" name="SSN" value={formData.SSN} onChange={handleChange} style={styles.input} />
                    </div>
                    <div style={styles.formGroup}>
