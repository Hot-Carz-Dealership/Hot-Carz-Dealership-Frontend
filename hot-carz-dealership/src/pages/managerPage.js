      ...
      return (
        <div style={styles.container}>
          <div style={styles.buttonsContainer}>
            <button style={styles.modalButton} onClick={() => { setSelectedTab(2); fetchData('')}}>Bids</button>
            <button style={styles.modalButton} onClick={() => { setSelectedTab(3); fetchData('testdrives')}}>Test Drives</button>
            <button style={styles.modalButton} onClick={() => { setSelectedTab(4); fetchData('members')}}>Customers</button>
            <button style={styles.modalButton} onClick={() => { setSelectedTab(5); fetchData('vehicles/search')}}>Vehicle Listings</button>
            <button style={styles.modalButton} onClick={() => { setSelectedTab(6); fetchData('')}}>Sales Report</button>
